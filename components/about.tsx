...
export default function About(){
    return <motion.section className='mb-28 max-we-[45rem] text-center leading-8 sm:mb-40 scroll-mt-28'
    ...
    id='about'>
        ...
        with a degree in <span className="font-medium">Computer
         Science</span>, my journey has taken me from coding
          with <span className="font-medium">HTML</span>,
           ...
           and <span className="font-medium">JavaScript </span>
            ...
            and <span className="font-medium">Cloud Computing</span>.
             I'm not just working with code;
             I'm engaging with the future, 
             learning every day, and loving every moment of this 
             exciting field.</p>
    </motion.section>
}