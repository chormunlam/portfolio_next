    ...
    >
      <div className="flex items-center justify-center">
        <div className="relative">
          ...
          >
            <Image
              src="https://images.unsplash.com/photo-1566251037378-5e04e3bec343?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1740&q=80"
              alt="sef"
              width="192"
              height="192"
              quality="95"
      ...
      >
        ...
        <span className="underline">web develop</span>.
      </motion.h1>
      ...
      >
        ...
        <a
          ...
          href="https://linkedin.com/chormun"
          target="_blank"
        >
          <BsLinkedin />
        </a>
